...
if args['tunnel']:
    if args['ip1']:
        ...
        print("Must specify --ip1 argument as well")
        exit(0)
    if args["ip2"]:
        g_ip2 = args["ip2"]
    else:
        print("Must specify --ip2 argument as well")
        exit(0)
    if args["spine1"]:
        g_spine1 = args["spine1"]
    else:
        print("Must specify --spine1 argument as well")
        exit(0)
    if args["spine2"]:
        g_spine2 = args["spine2"]
    else:
        print("Must specify --spine2 argument as well")
        exit(0)
